...
//set-up the static constants (each requires it's own rule...):
    ...
    $cp_bible = [
        ...
        3 => [
            ...
            "score" => [29,2,3],
            "puzzle" => true,
            "puzzle_q" => "Rearrange the missing letters from this alphabet to spell a European capital<br><br>CDFHIJKLMNOPQSTUVWXY",
            "puzzle_a" => "zagreb",
            "message" => "",
            "options" => [
                1 => "solve"
        ...
        4 => [
            ...
            "score" => [29,2,3],
            "puzzle" => true,
            "puzzle_q" => "1/2 of 2/3 of 3/4 of 4/5 of a number is 12.<br><br>What is 1/6 of that number?",
            "puzzle_a" => "10",
            "message" => "",
            "options" => [
                1 => "solve"
        ...
        6 => [
            ...
            "score" => [29,2,3],
            "puzzle" => true,
            "puzzle_q" => "What letter comes next in this sequence: S, S, F, F, T, T, E,...?",
            "puzzle_a" => "t",
            "message" => "",
            "options" => [
                1 => "solve"
        ...
        7 => [
            ...
            "score" => [29,2,3],
            "puzzle" => true,
            "puzzle_q" => "Amy and Chloe are sisters. Amy’s age this year, plus the square of Chloe’s age next year = 86. Chloe’s age this year plus the square of Amy’s age next year = 44. How was Chloe last year?",
            "puzzle_a" => "7",
            "message" => "",
            "options" => [
                1 => "solve"
    ...
    while ($z < $count_cps){
        ...
        if($cp["type"] == "dice") {
            ...
            if(in_array($cp_number,$player_details[$pl]["params"]["used_cps"])){
                ...
                $movement = (int) $cp["score"][$timezone];
