...
?","420"], 
    ...
    6 => [  0 => ["The square has a perimeter of 48cm. The square is cut in half. The two halves are put together to make the second shape. What is the perimeter of the second shape in cms <img class='puzzle_pic' src='assets/img/perimeter.png'>","60"], 
            1 => ["Using the following numbers, 4 6 8 10 12 20, add together three numbers each time to give 36. How many different ways are there to do this? Each number can be used as many times as you wish.","4"], 
